...
function App() {
  const projetos = [
    ...
    },
    {
      ...
      descricao:
        "Primeiro projetinho na Faculdade, para prática de HTML e CSS.",
    ...
    },
    {
      titulo: "Site Volêi",
      descricao:
        "Site desenvolvido com bootstrap, ideal para projetos mais simples.",
      ...
      <section className="skills" id="skills">
        ...
        <div className="skill-lista">
          {skills.map((skill, index) => (
            <Skills key={index} devicon={skill.devicon} skill={skill.skill} />
          ))}
        </div>
      </section>
